    ...
    <div className="movie-card__reviews movie-card__row">
      <div className="movie-card__reviews-col">
        <div className="review">
          <blockquote className="review__quote">
            <p className="review__text">
              ...
              glorious Mittel-European kitsch of one of the director&#39s
        ...
        <div className="review">
          <blockquote className="review__quote">
            <p className="review__text">
              Anderson&#39s films are too precious for some, but for those of us
              willing to lose ourselves in them, they&#39re a delight. &#34The
              Grand Budapest Hotel&#34 is no different, except that he has added
        ...
        <div className="review">
          <blockquote className="review__quote">
            <p className="review__text">
              I didn&#39t find it amusing, and while I can appreciate the
              creativity, it&#39s an hour and 40 minutes I wish I could take
              back.
            </p>
